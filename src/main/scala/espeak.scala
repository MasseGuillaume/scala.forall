...
object Mespeak extends js.Object {
  ...
  def speak(text: String, args: SpeakOptions = js.native, callback: Boolean => Unit = js.native, _id: Int = js.native): Int = js.native
  def speakMultipart(parts: Array[SpeakPart], args: SpeakOptions = js.native, callback: Boolean => Unit = js.native, _id: Int = js.native): Int = js.native
